class Solution {
    public int longestConsecutive(int[] nums) {
       ...
       for(int num: set){
       /* in first attempt I made mistake I don't need to run loop on all element from input(because main input may have so many duplicate, that will not good in case of high/very high input).
       Insted now I'm running loop on set.
       */
